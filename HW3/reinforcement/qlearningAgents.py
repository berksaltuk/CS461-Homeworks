...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state):
        ...
        bestAction = None
        for action in self.getLegalActions(state):
            if(self.getQValue(state, action) > max_actionQ):
    ...
    def getAction(self, state):
        ...
        return randomAction if (util.flipCoin(self.epsilon)) else bestAction
    ...
    def update(self, state, action, nextState, reward):
        ...
        self.qValues[(state, action)] = qOld + self.alpha * \
            (reward + self.discount * (self.computeValueFromQValues(nextState)) - qOld)
